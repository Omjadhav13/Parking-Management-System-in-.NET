...
namespace ParkingSystemApplication.Controllers
{
    public class ParkingSlotsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SlotId,SlotNumber,IsOccupied")] ParkingSlot parkingSlot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SlotId,SlotNumber,IsOccupied")] ParkingSlot parkingSlot)
        {
        ...
        {
            return _context.ParkingSlots.Any(e => e.SlotId == id);
        }
    }
}
